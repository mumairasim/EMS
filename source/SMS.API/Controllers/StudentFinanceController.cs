...
namespace SMS.API.Controllers
{
    ...
    public class StudentFinanceController : ApiController
    {
        ...
        public IHttpActionResult RequestGet(Guid id)
        {
            ...
            try
            {
                var result = _studentFinanceService.RequestGet(id);
                return Ok(result);
            }
            catch (Exception)
            {
        ...
        [HttpGet]
        [Route("RequestGetByFilter/{schoolId}/{classId}/{feeMonth}")]
        public IHttpActionResult RequestGetByFilter(Guid? schoolId = null, Guid? classId = null, Guid? studentId = null, string feeMonth = "0")
        {
            if (feeMonth == "0")
            {
                feeMonth = null;
            ...
            try
            {
                var result = _studentFinanceService.RequestGetByFilter(schoolId, classId, studentId, feeMonth);
                return Ok(result);
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult RequestDelete(Guid id)
        {
            ...
            try
            {
                _studentFinanceService.RequestDelete(id);
            }
            catch (Exception)
            {
                return InternalServerError();
